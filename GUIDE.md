...
5. **If you don't understand, say so.** "Explain that in plain words" is
   always a fair request. You are the judge of what the thing should do,
   and that part can't be delegated.
...
anything handling money, health, or other people's data, have a
